    ...
    <section className="py-32 min-h-screen bg-background text-white">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-24">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-playfair mb-6 text-white">{t.title}</h2>
            <p className="max-w-2xl mx-auto opacity-90 text-lg font-spline text-white/80">
              {t.description}
            </p>
          </motion.div>
        </div>
        ...
        <div className="mb-32">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8 mb-12">
            <h3 className="text-3xl md:text-4xl font-playfair text-white">{t.interior}</h3>
            <div className="h-px w-full bg-primary/20 hidden sm:block" />
          </div>
        ...
        <div>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8 mb-12">
            <h3 className="text-3xl md:text-4xl font-playfair text-white">{t.exterior}</h3>
            <div className="h-px w-full bg-primary/20 hidden sm:block" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
